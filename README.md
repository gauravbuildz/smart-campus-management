...
<img src="assets/hero-banner-v3.png" alt="Smart Campus Service Hub Hero Banner" width="100%" height="280" style="border-radius: 8px; object-fit: cover;" />
...
<p align="center">
  <a href="https://smart-campus-servicehub.vercel.app" target="_blank">
    <img src="https://img.shields.io/badge/🌐_Live_Website-000000?style=for-the-badge&logo=vercel&logoColor=white" alt="Live Website" />
  </a>&nbsp;&nbsp;
...
[![GitHub stars](https://img.shields.io/github/stars/gauravbuildz/smart-campus-service-hub?style=flat-square&color=yellow&logo=github)](https://github.com/gauravbuildz/smart-campus-service-hub/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/gauravbuildz/smart-campus-service-hub?style=flat-square&color=lightgrey&logo=github)](https://github.com/gauravbuildz/smart-campus-service-hub/network/members)
[![GitHub last commit](https://img.shields.io/github/last-commit/gauravbuildz/smart-campus-service-hub?style=flat-square&color=blue)](https://github.com/gauravbuildz/smart-campus-service-hub/commits/main)
...
<a id="walkthrough"></a>
<img src="https://github.com/gauravbuildz/smart-campus-service-hub/raw/main/assets/demo.gif" alt="Smart Campus Walkthrough" width="100%" style="border-radius: 8px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.15);" />
...
| | |
|:---:|:---:|
| <a href="screenshots/01-landing-page.png" target="_blank"><img src="screenshots/01-landing-page.png" alt="Landing Portal" width="100%" style="border-radius: 6px; border: 1px solid #ddd;" /></a><br><sub>**Landing Portal**<br>Institutional gateway with clean onboarding and quick action entrypoints</sub> | <a href="screenshots/02-login-page.png" target="_blank"><img src="screenshots/02-login-page.png" alt="Login Page" width="100%" style="border-radius: 6px; border: 1px solid #ddd;" /></a><br><sub>**Secure Authentication**<br>Credential login page protected by NextAuth JWT sessions</sub> |
| <a href="screenshots/03-signup-page.png" target="_blank"><img src="screenshots/03-signup-page.png" alt="Signup Page" width="100%" style="border-radius: 6px; border: 1px solid #ddd;" /></a><br><sub>**Student Registration**<br>Unified sign-up flow with instant input validation</sub> | <a href="screenshots/04-student-dashboard.png" target="_blank"><img src="screenshots/04-student-dashboard.png" alt="Student Dashboard" width="100%" style="border-radius: 6px; border: 1px solid #ddd;" /></a><br><sub>**Student Workspace**<br>Self-service hub for resource access, notices, and tracking</sub> |
| <a href="screenshots/05-notices-event.png" target="_blank"><img src="screenshots/05-notices-event.png" alt="Notice Board" width="100%" style="border-radius: 6px; border: 1px solid #ddd;" /></a><br><sub>**Dynamic Notice Board**<br>Categorized event listings and official announcements</sub> | <a href="screenshots/06-lost-found.png" target="_blank"><img src="screenshots/06-lost-found.png" alt="Lost & Found" width="100%" style="border-radius: 6px; border: 1px solid #ddd;" /></a><br><sub>**Lost & Found Marketplace**<br>Visual feed of lost items with image proof claim uploads</sub> |
| <a href="screenshots/07-resource-hub.png" target="_blank"><img src="screenshots/07-resource-hub.png" alt="Resource Hub" width="100%" style="border-radius: 6px; border: 1px solid #ddd;" /></a><br><sub>**Shared Resource Hub**<br>Downloadable campus documents, handbooks, and schedules</sub> | <a href="screenshots/08-service-request.png" target="_blank"><img src="screenshots/08-service-request.png" alt="Service Request" width="100%" style="border-radius: 6px; border: 1px solid #ddd;" /></a><br><sub>**Digital Service Requests**<br>Online document and certificate application form workflow</sub> |
| <a href="screenshots/09-student-profile.png" target="_blank"><img src="screenshots/09-student-profile.png" alt="Student Profile" width="100%" style="border-radius: 6px; border: 1px solid #ddd;" /></a><br><sub>**Student Profile Management**<br>User settings and active session tracking</sub> | <a href="screenshots/10-admin-dashboard.png" target="_blank"><img src="screenshots/10-admin-dashboard.png" alt="Admin Dashboard" width="100%" style="border-radius: 6px; border: 1px solid #ddd;" /></a><br><sub>**Admin Control Panel**<br>Unified queue for managing notice releases and complaints</sub> |
| <a href="screenshots/11-student-management.png" target="_blank"><img src="screenshots/11-student-management.png" alt="Student Management" width="100%" style="border-radius: 6px; border: 1px solid #ddd;" /></a><br><sub>**Student Records Administration**<br>Admin tools to view, search, and manage registered students</sub> | <a href="screenshots/12-analytics-hub.png" target="_blank"><img src="screenshots/12-analytics-hub.png" alt="Analytics" width="100%" style="border-radius: 6px; border: 1px solid #ddd;" /></a><br><sub>**Operational Analytics Hub**<br>Visualized campus logs, resolution metrics, and activity charts</sub> |
...
flowchart TD
    subgraph Client ["🖥️ CLIENT PORTAL"]
        Browser([🌐 Web Browser])
    end

    subgraph App ["⚡ NEXT.JS ENGINE"]
        NextJS["🛣️ App Router & Pages"]
        AuthGuard{"🔒 NextAuth Session Guard"}
        AuthRoutes["📂 Role-Based Route Rewriter"]
        APILayer["📡 Serverless API Routes"]
    end
    ...
    Browser -->|1. HTTPS Request| NextJS
    NextJS -->|2. Check Authentication| AuthGuard
    AuthGuard -->|3. Route Authorization| AuthRoutes
    AuthRoutes -->|4. Request Processing| APILayer
    APILayer -->|5. Type-Safe Queries| Prisma
    Prisma -->|6. CRUD Operations| PG
```
